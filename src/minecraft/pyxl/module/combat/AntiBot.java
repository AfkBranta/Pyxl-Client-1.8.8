...
import pyxl.event.events.EventReceivePacket;
...
public class AntiBot extends Module {
    ...
    public void setup() {
        ...
        Pyxl.instance.settingsManager.rSetting(new Setting("AntiBot Mode", this, "Advanced", options));
    }

    @EventTarget
    public void onReceivePacket(EventReceivePacket event) {
        String mode = Pyxl.instance.settingsManager.getSettingByName("AntiBot Mode").getValString();
