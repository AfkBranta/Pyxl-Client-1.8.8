...
extends GuiScreen {
    ...
    private AltManagerThread thread;
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 0: {
                this.thread = new AltManagerThread(this.username.getText(), this.password.getText());
                this.thread.start();
            }
        }
    }
    ...
    public void drawScreen(int x2, int y2, float z2) {
        ...
        this.drawCenteredString(this.mc.fontRendererObj, "Alt Manager", width / 2, 20, -1);
